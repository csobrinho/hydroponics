...
typedef struct Hydroponics__Sampling Hydroponics__Sampling;
typedef struct Hydroponics__Controller Hydroponics__Controller;
typedef struct Hydroponics__Controller__Entry Hydroponics__Controller__Entry;
typedef struct Hydroponics__Controller__Entry__Pid Hydroponics__Controller__Entry__Pid;
typedef struct Hydroponics__Task Hydroponics__Task;
typedef struct Hydroponics__Task__Cron Hydroponics__Task__Cron;
typedef struct Hydroponics__HardwareId Hydroponics__HardwareId;
typedef struct Hydroponics__StartupState Hydroponics__StartupState;
typedef struct Hydroponics__Firmware Hydroponics__Firmware;
typedef struct Hydroponics__Config Hydroponics__Config;
...
struct  Hydroponics__Controller__Entry__Pid
{
  ProtobufCMessage base;
  int32_t sampling;
  float p;
...
struct  Hydroponics__Controller__Entry
{
  ProtobufCMessage base;
  float target;
  float min;
...
struct  Hydroponics__Controller
{
  ProtobufCMessage base;
...
struct  Hydroponics__Task__Cron
{
  ProtobufCMessage base;
...
struct  Hydroponics__HardwareId
{
  ProtobufCMessage base;
  char *name;
  char *dev_id;
...
struct  Hydroponics__StartupState
{
  ProtobufCMessage base;
  Hydroponics__OutputState state;
  size_t n_output;
